...
- As caching is not possible in Free Edition of Databricks, I have not done that, it will give major performance improvement. Like final joined dataframe should be cached, as it's being used multiple times.
